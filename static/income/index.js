...
const income_table = document.querySelector(".income-table > table");
...
function update_table(search_querry = "", page_num = 1) {
    let body = income_table.querySelector("tbody");
    body.innerHTML = "";
    curr_page_num.innerText = page_num;
    fetch(`income_search/${page_num}`, {
        ...
        .then((data) => {
            ...
            for (let r of incomes) {
                ...
                edit_btn.href = `edit_income/${r["id"]}`;
    ...
    const myChart = new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: "Income in last 30 days by different sources",
                    position: "top",
                    font: {
                        size: 17
                    }
